...
variable "prometheus_cpu_request"    { type = string; default = "500m" }
variable "prometheus_memory_request" { type = string; default = "2Gi" }
variable "prometheus_cpu_limit"      { type = string; default = "2000m" }
variable "prometheus_memory_limit"   { type = string; default = "8Gi" }
